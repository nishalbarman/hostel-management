    ...
    <div class="popup-content">
        ...
        <div class="popup-body" id="popup-body">
            ...
            <li>
                ...
                <input id="roomno" type="number" name="roomno" class="field-long" required />
            </li>

            <li>
                <label>Seats <span class="required">*</span></label>
                <input id="seatno" type="number" name="seat" class="field-long" required />
            </li>
            <center>
                <button id="add-room"
...
<script>
    ...
    function addRoomDetails() {
        const room = document.getElementById("roomno");
        const seat = document.getElementById("seatno");

        let roomno = room.value;
        let seatno = seat.value;
        ...
        fetch("./ajax-php/add-room.php", postData).then(res => res.json()).then(data => {
            alert(data.msg);
        })
